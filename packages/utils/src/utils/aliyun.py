...
region_id = os.environ.get("OSS_REGION_ID")

print(access_key_id, "access_key_idaccess_key_idaccess_key_id-----")
...
async def generate_upload_params(filename):
    # 构建文件的key
    ...
    assume_role_request = sts_20150401_models.AssumeRoleRequest(
        role_arn=role_arn_for_oss_upload, role_session_name=role_session_name
    )
    ...
    response_data = {
        ...
        "x_oss_credential": f"{temp_access_key_id}/{dt_obj_2}/{region_id}/oss/aliyun_v4_request",  # 指明派生密钥的参数集
